...
public class PacketUtil {
  ...
  public static final FieldPacket getField(String name, String orgName, int type) {
    ...
    packet.name = LiteBaseStringUtil.encode(name, CODE_PAGE_1252);
    packet.orgName = LiteBaseStringUtil.encode(orgName, CODE_PAGE_1252);
  ...
  public static final FieldPacket getField(BinaryPacket src, String fieldName) {
    ...
    field.read(src);
    field.name = LiteBaseStringUtil.encode(fieldName, CODE_PAGE_1252);
