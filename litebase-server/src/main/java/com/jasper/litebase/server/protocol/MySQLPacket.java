...
public abstract class MySQLPacket {
    ...
    /**
     * 把数据包写到buffer中，如果buffer满了就把buffer通过前端连接写出。 TODO 这里可以优化下，把ByteBuf包装下，如果写满4K，就写回到客户端，然后清空；如果没有，就只写到ByteBuf
     *
     * @param buffer
     */
    ...
    public String toString() {
        return getPacketInfo() + "{length=" + packetLength + ",id=" + packetId + '}';
    }
}
